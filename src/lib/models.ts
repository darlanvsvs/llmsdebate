...
export const ALL_MODELS: ModelInfo[] = [
  ...
  },
  {
    ...
    provider: "openrouter",
    free: true,
    description: "Modelo aberto robusto com zero restrições de chamadas de API (rate limit) no plano atual.",
    strengths: ["Disponibilidade Excepcional", "Zero rate limits", "Bom contexto"],
    costTier: "grátis",
    bestFor: "Debates de alta frequência focado na rapidez com baixo rate limit.",
  },
  {
    ...
    provider: "openrouter",
    free: true,
    description: "Modelo Liquid super veloz e altamente resiliente focado em cadeia de pensamentos pré-resposta.",
    strengths: ["Ultra rápido", "Excelente disponibilidade", "Pensamento estruturado"],
    costTier: "grátis",
    bestFor: "Análises sintéticas e raciocínio paso a passo na deliberação sem risco de queda.",
  },
  {
    ...
    provider: "openrouter",
    free: true,
    description: "Modelo otimizado da Upstage de altíssima qualidade visual e contextual. Muito estável.",
    strengths: ["Lógica aprimorada", "Contexto profundo", "Alta estabilidade"],
    costTier: "grátis",
    bestFor: "Geração estável e debates massivos em conhecimento geral sem timeout.",
  },
  {
    ...
    provider: "openrouter",
    free: true,
    description: "Um gigante aberto da familia Qwen que segue gratuito e extremamente performático em altas cargas.",
    strengths: ["Ponderação", "Raciocínio robusto", "Alta confiabilidade"],
    costTier: "grátis",
    bestFor: "Deliberações profundas usando o motor cognitivo forte do ecosistema Qwen.",
  },
  {
    ...
    provider: "openrouter",
    free: true,
    description: "Eficiente e sucinto modelo instrucional da Liquid, ótimo para seguir comandos precisos.",
    strengths: ["Resposta direta", "Baixa latência", "100% Online"],
    costTier: "grátis",
    bestFor: "Respostas curtas que exigem formatação exata sem timeout.",
  }
];
